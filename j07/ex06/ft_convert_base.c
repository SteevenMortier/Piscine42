...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/08/16 23:09:09 by smortier          #+#    #+#             */
/*   Updated: 2017/08/24 13:49:46 by smortier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*convert_to_b(char *base_to, int base_ten, int neg)
{
	...
	tab = (char *)malloc(sizeof(char) * len_string + 1);
	x = 0;
	tab[len_string] = '\0';
	while (base_ten != 0)
	{
...
char	*ft_convert_base(char *nbr, char *base_from, char *base_to)
{
	...
	{
		exep = (char *)malloc(sizeof(char) * 2);
		exep[0] = base_to[0];
		exep[1] = '\0';
		return (exep);
	}
